...
Game.Screen.levelAbilitiesScreen = {
    ...
    render: function(display){
        ...
        for (var i = 0; i < this._options.length; i++) {
            display.drawText(0, 2 + i, 
                letters.substring(i, i + 1) + ' - ' + this._options[i] + "  || Current Level: " + this._abilities[this._options[i]].level + " -- To Next Level: " + this._abilities[this._options[i]].toNext + "  || Total " + this._abilities[this._options[i]].totalPoints);
        }
